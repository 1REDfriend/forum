...
<template>
  <div class="flex min-h-screen bg-gray-50 w-full justify-center">
    <div class="w-full max-w-5xl mx-auto pt-24 px-4 sm:px-6 pb-12">
      ...
      <div v-else class="bg-white shadow-sm border border-gray-100 rounded-xl overflow-hidden">
        ...
        <!-- Column Headers -->
        <div
          class="hidden sm:grid grid-cols-12 gap-2 h-10 bg-gray-50 border-b border-gray-100 text-xs uppercase tracking-wider font-semibold text-gray-400 px-5 items-center select-none">
        ...
        <div v-for="forum in forums" :key="forum.id"
          ...
          <div class="hidden sm:flex col-span-3 items-center gap-2 min-w-0">
            <div v-if="forum.lastPostAt" class="min-w-0 flex-1">
              ...
              <p
                :class="['text-xs truncate', isForumUnread(forum) ? 'text-orange-500 font-semibold' : 'text-gray-400']">
