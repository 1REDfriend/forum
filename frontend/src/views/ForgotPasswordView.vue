    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        ...
        <div v-if="successMessage" class="text-center">
          ...
          <p class="text-gray-700 font-medium">{{ successMessage }}</p>
          <p class="text-sm text-gray-500 mt-2">Check your inbox (and spam folder).</p>
          <router-link to="/login" class="mt-6 inline-block text-indigo-600 hover:underline text-sm font-medium">
            ← Back to Login
          </router-link>
        </div>
        ...
        <form v-else @submit.prevent="submit" class="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 transition"
            />
          </div>
