...
<template>
    <main class="min-h-screen flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 pt-24">
        <div class="w-full max-w-md">
            <h2 class="mt-6 text-center text-3xl font-extrabold text-(--color-heading)">Sign in to your account</h2>
            <p class="mt-2 text-center text-sm text-(--color-text-muted)">
                Or
                <router-link to="/register" class="font-medium text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300">
                ...
                <form class="space-y-6" @submit.prevent="handleLogin">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <router-link to="/forgot-password" class="text-xs text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300 hover:underline">
                                Forgot password?
                            </router-link>
                        </div>
                        <div class="mt-1">
